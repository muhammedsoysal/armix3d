...
export const telemetryStore = createStore<TelemetryStoreState>()((set) => ({
  machines: {
    ...
    "WLD-1": machine("WLD-1", "Robotik Kaynak Hücresi", "MIG/MAG Robot"),
    "TBL-1": machine("TBL-1", "Boru Lazer Hattı", "Tube Laser"),
    "PLZ-1": machine("PLZ-1", "Plazma Kesim Portalı", "HD Plasma"),
    "PWD-1": machine("PWD-1", "Toz Boya Tüneli", "Powder Coating"),
  },
  connected: false,
  source: "mock",
  wsEvents: 0,
